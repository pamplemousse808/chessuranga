...
export const ASURA_DECK = [
  ...
  { id: "KALI_ASURA", name: "Kali", color: "#4A0E4E", radius: 2, tier: 3, cost: 8, description: "Capture any adjacent enemy piece, ignoring movement rules", image: "/images/kali.jpg" },
  { id: "VRITRA", name: "Vritra", color: "#0A2A4A", radius: 2, tier: 3, cost: 9, description: "White pieces cannot enter or cross this piece's rank for 2 turns", image: "/images/vritra.jpg" },
];
