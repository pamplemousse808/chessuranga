...
export const SHARED_DECK = [
  ...
  { id: "KETU", name: "Ketu", color: "#f97316", radius: 3, tier: 1, cost: 8, description: "If captured, returns to starting square instead of dying", image: "/images/ketu.jpg" },
  ...
  { id: "GURU", name: "Guru", color: "#a855f7", radius: 2, tier: 2, cost: 9, description: "Spawn a real duplicate left or right — it moves and captures for 2 turns then dissolves", image: "/images/guru.jpg" },
  { id: "SHUKRA", name: "Shukra", color: "#ec4899", radius: 2, tier: 2, cost: 11, description: "Resurrect a captured piece where it died", image: "/images/shukra.jpg" },
  // Tier 3
...
export const ASURA_DECK = [
  ...
  { id: "KALI_ASURA", name: "Kali", color: "#4A0E4E", radius: 2, tier: 1, cost: 8, description: "Capture any adjacent enemy piece, ignoring movement rules", image: "/images/kali.jpg" },
  // Tier 2
  ...
  { id: "VRITRA", name: "Vritra", color: "#0A2A4A", radius: 2, tier: 2, cost: 9, description: "White pieces cannot enter or cross this piece's rank for 2 turns", image: "/images/vritra.jpg" },
  ...
  { id: "SHUMBHA", name: "Shumbha-Nishumbha", color: "#7A3B00", radius: 1, tier: 3, cost: 12, description: "Capture an enemy piece then snap back to your origin square", image: "/images/shumbhanishumbha.jpg" },
  { id: "SHUKRA_ASURA", name: "Shukracharya", color: "#C2185B", radius: 1, tier: 3, cost: 11, description: "Pawns promote to any captured piece type when reaching halfway", image: "/images/shukracharya.jpg" },
];
