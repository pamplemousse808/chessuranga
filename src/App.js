...
function HowToPlay() {
  ...
  return (
    <div style={{ maxWidth: "400px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", marginBottom: "0", borderRadius: "12px 12px 0 0", overflow: "hidden" }}>
        <button
          ...
          style={{
            ...
            border: "none",
            cursor: "pointer",
            backgroundColor: activeTab === 'asura' ? "#ff4444" : "#3a2a2a",
            color: "#fff",
        ...
        <button
          ...
          style={{
            ...
            border: "none",
            cursor: "pointer",
            backgroundColor: activeTab === 'shukra' ? "#e8d5a3" : "#2a2a1a",
            color: activeTab === 'shukra' ? "#1a0a00" : "#fff",
            transition: "background-color 0.2s"
          }}
        >
          ☄️ Shukracharya
      ...
      {/* Panel */}
      <div style={{
        backgroundColor: activeTab === 'asura' ? "#ff4444" : "#c8a96e",
        border: `3px solid ${activeTab === 'asura' ? '#ff6b6b' : '#e8d5a3'}`,
        borderTop: "none",
        borderRadius: "0 0 16px 16px",
        padding: "24px",
        color: activeTab === 'asura' ? "#fff" : "#1a0a00",
        boxShadow: activeTab === 'asura' ? "0 0 40px rgba(255,68,68,0.4)" : "0 0 40px rgba(232,213,163,0.3)",
        textAlign: "left"
      }}>
        ...
        {activeTab === 'asura' ? (
          ...
          <>
            <div style={{ marginBottom: "14px" }}>
              <div style={{ fontWeight: "bold", fontSize: "15px", marginBottom: "4px" }}>☄️ Your Challenge</div>
              <div style={{ fontSize: "13px", opacity: 0.9, lineHeight: "1.5" }}>
                Take on Shukracharya, Guru of the Asuras — the mastermind behind the horde.
              </div>
            </div>
            <div style={{ marginBottom: "14px" }}>
              <div style={{ fontWeight: "bold", fontSize: "15px", marginBottom: "4px" }}>🌟 Your Allies</div>
